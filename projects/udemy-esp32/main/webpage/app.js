...
function showTab(tab) {
	document.getElementById('tab-ota').style.display  = (tab === 'ota')  ? 'block' : 'none';
	document.getElementById('tab-hand').style.display = (tab === 'hand') ? 'block' : 'none';
	document.getElementById('btn-ota').className  = 'tab-btn' + (tab === 'ota'  ? ' active' : '');
	document.getElementById('btn-hand').className = 'tab-btn' + (tab === 'hand' ? ' active' : '');
	if (tab === 'hand') { initHand(); }
}
